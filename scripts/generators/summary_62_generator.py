		...
		<div class="pure-u-22-24" id="main_col">
			<div id="main_content">
                ...
                <div id="node_links_cont">
                    ...
                    <p><h5>Note: Mus samples not yet included in assembly and mapping analyses</h5></p>
...
# Main block
######################
pagefile = "summary_62.html";
print("Generating " + pagefile + "...");
title = "62 exome summary"

head = RC.readHead(title);
nav = RC.readNav(pagefile);
footer = RC.readFooter();

page_title = "Summary of 62 exome samples"

infilename = "../../data/summary-62-exomes.csv";
